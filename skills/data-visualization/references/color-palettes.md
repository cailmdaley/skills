...
A preferred aesthetic palette. Use individual colors for categorical data, seaborn blends for sequential.
...
The `forestdawn` colormap from [suisai](https://github.com/yomori/suisai) fits the Porch Morning aesthetic. Teal-green to cream to rust-orange.
